...
workspace: 生态
type: output
tags: [生态, Kami, 设计系统, CSS, 排版, PDF, PPTX, 参考手册]
aliases: [kami-design-spec-reference, Kami设计规范, Kami设计系统参考]
created: 2026-05-22
---

> [!index] 导航
> 🏠 [[00-仪表盘]] > [[MOC-生态]] > [[MASTER-路由中枢]] > **kami-design-spec-reference**
> 相关：[[kami-integration-analysis]] · [[SOP索引-全量]]
...
| 2x2 columns misaligned | Switch from CSS Grid to `table.t2x2` |
...
2. 2x2 layouts use `table`, not grid
