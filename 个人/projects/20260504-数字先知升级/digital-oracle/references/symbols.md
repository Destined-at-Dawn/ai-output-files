...
## 认知科学支撑：Yahoo Finance交易符号目录的认知原理（百大认知书籍）

| 认知机制 | 来源 | 在交易符号目录中的应用 |
|---------|------|------------------------------|
| **符号表** | 025-认知负荷理论 §concept1 | 交易符号=符号表——"AAPL=Apple/TSLA/Tesla"→"符号=速记→"没有符号表→每次都要查→效率=1/10" |
| **选择性注意** | 022-认知神经科学 §concept1 | 符号目录=选择性注意——"从数千只股票中→筛选出需要的→"目录='注意力的过滤器'" |
