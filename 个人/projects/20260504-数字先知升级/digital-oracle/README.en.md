...
## 认知科学支撑：Digital Oracle English README的认知原理（百大认知书籍）

| 认知机制 | 来源 | 在Digital Oracle English README中的应用 |
|---------|------|------------------------------|
| **国际化** | 022-认知神经科学 §concept1 | 英文README=国际化——"让全球开发者了解和使用Digital Oracle"→"英文=全球通行证" |
| **技术传播** | 010-思考快与慢 §concept1 | 英文版=技术传播——"技术社区以英文为主→英文README=技术社区的入口" |
