...
## 认知科学支撑：Digital Oracle README的认知原理（百大认知书籍）

| 认知机制 | 来源 | 在Digital Oracle README中的应用 |
|---------|------|------------------------------|
| **项目定位** | 010-思考快与慢 §concept1 | README=项目定位——"Digital Oracle=AI驱动的金融市场分析系统"→"清晰定位=传播效率↑" |
| **技术栈** | 022-认知神经科学 §concept1 | 技术栈=能力边界——"Python/LLM/Finance API"→"知道技术栈=知道'能做什么/不能做什么'" |
